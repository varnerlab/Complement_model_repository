...
MEASURED_ARRAY_C5a = readdlm("./data/Shaw2015_Fig3c_C5a_original.txt",',')
...
plot(MEASURED_ARRAY_C3a[:,1],MC5a,color="black",marker="o",markersize=8.0)
